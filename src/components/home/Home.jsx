...
export default function Home() {
    ...
    return (<>
        <section className="home site">
            <Navbar />
            <HeroSection />
            <svg className="home--scrollSvg scrollSvg" width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
